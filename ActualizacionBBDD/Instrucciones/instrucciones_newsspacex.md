...
```json
{
  "title": "Próximo Vuelo de Starship: IFT-4",
  "title_en": "Next Starship Flight: IFT-4",
  "excerpt": "SpaceX se prepara para el cuarto vuelo de prueba de Starship desde Starbase...",
  "excerpt_en": "SpaceX prepares for the fourth test flight of Starship from Starbase...",
  "category": "Starship",
  "category_en": "Starship",
  "location": "Starbase",
  "location_en": "Starbase",
  "date": "2026-04-15",
  "slug": "proximo-vuelo-starship-ift-4",
  "rutanoticia": "/api/v1/newsspacex_content/260415_ift4.md",
  "image": "ift4_test.webp",
  "tags": ["Starship", "SpaceX", "Marte"],
  "tags_en": ["Starship", "SpaceX", "Mars"]
}
```
